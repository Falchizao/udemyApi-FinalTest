...
import br.com.teste.primeirorest.http.AnimaisFeignCliente;
...
public class PessoaServiceImpl implements PessoaService {
    ...
    @Autowired
    private AnimaisFeignCliente animaismscliente;
    ...
    public Optional<PessoaDto> obterPorId(Integer id) {
       ...
       if(pessoa.isPresent()) {
            ...
            List<AnimalDto> animais = animaismscliente.obterAnimais(id);
            //Add person's animais into the object
